This guide covers creating and configuring an EKS cluster with this
...
The script will take you through a series of questions that will populate the variables file required to create the EKS cluster. This variables file will be located at:
...
- `EKS_USER`: If desired, this indicates an AWS IAM user that can be set up in order to have minimum permissions to set up a new EKS cluster and install Ascender and its associated components.
