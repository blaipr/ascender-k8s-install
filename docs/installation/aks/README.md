This guide covers creating and configuring an AKS cluster with this
...
The script will take you through a series of questions that will populate the variables file required to create the AKS cluster. This variables file will be located at:
...
After running `setup.sh`, `tmp_dir` will contain  a directory called `aks-deploy`. This directory will contain the terraform state files and artifacts for your AKS cluster.
