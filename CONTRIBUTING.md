# Contributing to the Ascender Kubernetes Installer

Thanks for your interest in contributing to the Ascender Kubernetes Installer. This document covers the
...
```bash
git clone https://github.com/<your-user>/ascender-k8s-install.git
...
Open an issue at
[github.com/ctrliq/ascender-k8s-install/issues](https://github.com/ctrliq/ascender-k8s-install/issues).
